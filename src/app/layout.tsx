...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <head>
        <link rel="icon" href="data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><defs><clipPath id=%22clip%22><circle cx=%2250%22 cy=%2250%22 r=%2250%22/></clipPath></defs><g clip-path=%22url(%23clip)%22><image href=%22/pp.png%22 width=%22100%22 height=%22100%22/></g></svg>"/>
